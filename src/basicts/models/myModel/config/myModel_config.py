...
class MyModelConfig(BasicTSModelConfig):
    ...
    cnn_out_channels: int = field(default=16, metadata={"help": "Number of output channels in CNN layers."})
    ...
    hidden_sizes: list=field(default_factory=lambda: [8], metadata={"help": "GTUhidden feature sizes."})